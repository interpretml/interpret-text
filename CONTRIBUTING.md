...
* [Coding Guidelines](#yourRepo-team-contribution-guidelines)
...
Please review the [coding guidelines](https://github.com/microsoft/interpret-community-text/wiki/Coding-Guidelines) wiki page to see more details about the expectations for development approach and style.
...
Apart from the official Code of Conduct developed by Microsoft, in the yourRepo team we adopt the following behaviors, to ensure a great working environment:
